...
if source_radio == "IMAGE":
    ...
    if input is not None:
        ...
        st.markdown(f"<h2 style='color: red;'>imagenet_classes</h2>"<h4 style='color: blue;'><strong>The result of running the AI inference on an image:</strong></h4>, unsafe_allow_html=True)
